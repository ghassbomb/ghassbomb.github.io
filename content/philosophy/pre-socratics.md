...
They did not abandon all religious thought, which would be quite a tough prospect for any individual, but they prioritized *rational discourse* — a first in Western thought. A 'fanatical concern with logical consistency and rules of thinking', leading to some empirically ridiculous but *theoretically* sound ideas (like [Zeno's Paradoxes](#eleatic-philosophy)), contributed to a suspicious popular perception towards philosophy that still holds today.
